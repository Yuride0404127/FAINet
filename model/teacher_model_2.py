...
#         self.conv_cat = DSConv3x3(3 * out_channel, out_channel)
#         self.conv_out = DSConv3x3(out_channel, out_channel)
...
#         x_add = x_up + x_cat + x_down
#         x_out = self.conv_out(x_add)
#
#         return x_out
...
class KD_model_3_teacher_2(nn.Module):
    def __init__(self):
        super(KD_model_3_teacher_2, self).__init__()
        # Backbone model
        self.rgb = shunted_s(pretrained=True)
        self.depth = shunted_s(pretrained=True)
    ...
    def forward(self, x_rgb, x_depth):
        ...
        fdw4_out = self.fdw4(aca4_out, (depth_4 + rgb_4))
